...
Create Table Khoa (
	...
	TenKhoa varchar(30) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci
)
*/
Create Table NganhHoc (
	MaNganh varchar(10) Not null Primary key,
	TenNghanh varchar(50) Not null CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci, -- utf8 -> utf8mb4
	ChiTiet varchar(21844)
)
Create Table MonHoc (
	MaMon varchar(10) Not null Primary key,
	MaNganh varchar(10) Not null,
	TenMon varchar(30) Not null CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
Create Table GiangVien (
	...
	HoTen varchar(50) Not null CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci,
	GioiTinh varchar(3) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci
)
...
Create Table Lop (
	...
	TenLop varchar(30) Not null CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci
)
...
Create Table LichTrinh (
	...
	BaiHoc varchar(50) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci, 
	Thoigian datetime,
	Foreign Key (MaLHP) References LopHocPhan(MaMaLHP),
...
Create Table NhanVien (
	...
	HoTen varchar(25) Not null CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci,
	GioiTinh varchar(3) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci,
	ChucVu varchar(25) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci
)
...
Create Table DanhMucTT (
	...
	TenDM varchar(120) Not null CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci
)
Create Table TinTuc (
	MaTin tinyint UNSIGNED Not null Primary key AUTO_INCREMENT,
	TieuDe varchar(120) Not null CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci,
	TomTat varchar(500) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci,
	HinhAnh mediumblob Not null, --  ~ 16 megabytes
	MoTa varchar(21844) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci,
